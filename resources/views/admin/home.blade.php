            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="ibox ibox-fullheight">
                        <div class="ibox-head">
                            <div class="ibox-title">أحدث البرامج التدريبية</div>
                        </div>
                                            ...
                                            <span class="btn-icon-only btn-circle bg-primary-50 text-primary">
                                                @switch($item->type)
                                                    ...
                                                    @case("new_request")
                                                        ...
                                                        @php $type = "طلبات مالية جديدة";  @endphp
                                                        @break
                                                    @case("exceed_limit")
                                                        <i class="fa fa-money"></i>
                                                        @php $type = "طلب مالي يتعدى حد الصرف";  @endphp
                                                        @break
                                                    @case("new_course")
                                                        <i class="fa fa-list"></i>
                                                        @php $type = "اضافة برنامج تدريبي جديد";  @endphp
                                                        @break
                                                    @case("completed")
                                                    ...
                                                    @default
                                                        ...
                                                        @php $type = "أحدث التنبيهات"; @endphp
                                                        @break
