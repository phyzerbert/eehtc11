...
>>>>>>> cdd4cff71cf8790b5e8f6b111209845ae2f13e4b
                                ...
                                <div class="col-3 pl-4">
                                    <h6 class="mb-3">منسقي البرنامج</h6>
                    ...
                    <div class="ibox">
                        <div class="ibox-head">
                            <div class="ibox-title">منسقي البرنامج</div>
                            @if ($role == 'project_manager')                                
                                <a href="#" id="btn-add-member" class="btn btn-sm btn-primary btn-fix float-right mb-2"><span class="btn-icon"><i class="ti-plus"></i>أضف منسق</span></a>
                            @endif
                        </div>
                        <div class="ibox-body">
                                ...
                                @foreach ($course->members as $member)
                                    <li class="media align-items-center py-1">
                                        ...
                                        <div class="media-body d-flex align-items-center">
                                            ...
                                            <span class="badge badge-success badge-pill">منسق</span>
                                        </div>
                                    </li>
                                @endforeach
                    ...
                    <div class="ibox">
                        <div class="ibox-head">
                            <div class="ibox-title">الطلبات المالية للبرنامج التدريبي</div>
                            {{-- @if ($role == 'project_manager')                                
                                <a href="#" id="btn-add-member" class="btn btn-sm btn-primary btn-fix float-right mb-2"><span class="btn-icon"><i class="ti-plus"></i>أضف منسق</span></a>
                            @endif --}}
                        </div>
            ...
            <div class="modal-content">
                <form action="{{route('add.member')}}" method="post" id="add_form">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">أضف منسق جديد</h4>
                        <button type="button" class="close" data-dismiss="modal">×</button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="control-label w-100">الإسم<span class="text-danger">*</span></label>
                            <div class="w-100">
